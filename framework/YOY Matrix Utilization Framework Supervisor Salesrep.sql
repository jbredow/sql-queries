SELECT REGION,
       ...
       NVL (
          SUM (
             CASE
                WHEN ROLL12MONTHS = 'LAST TWELVE MONTHS'
                THEN
       ...
       NVL (
          SUM (
             CASE
                WHEN ROLL12MONTHS = 'LAST TWELVE MONTHS' THEN SLS.TOTAL_LINES
                ELSE 0
             END),
          0)
          EX_LINES,
       ...
       SUM (
          CASE
             WHEN     PRICE_CATEGORY_FINAL IN ('MATRIX', 'MATRIX_BID', 'NDP')
                  AND ROLL12MONTHS = 'LAST TWELVE MONTHS'
             THEN
                SLS.EXT_SALES_AMOUNT
             ELSE
                0
       ...
       NVL (
          SUM (
             CASE
                WHEN ROLL12MONTHS = 'LAST TWELVE MONTHS LAST YEAR'
                THEN
                   SLS.EXT_SALES_AMOUNT
                ELSE
                   0
       ...
       SUM (
          CASE
             WHEN     PRICE_CATEGORY_FINAL IN ('MATRIX', 'MATRIX_BID', 'NDP')
                  AND ROLL12MONTHS = 'LAST TWELVE MONTHS LAST YEAR'
             THEN
                SLS.EXT_SALES_AMOUNT
             ELSE
                0
