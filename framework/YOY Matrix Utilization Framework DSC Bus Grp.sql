...
FROM (SELECT TPD.ROLL12MONTHS,
             ...
             -- NVL(BG.BUSINESS_GROUP,'OTHER') CUST_BUS_GRP,
              NVL(BG.BUSGRP,'OTHER') CUST_BUS_GRP,
              NVL(BG.BUDGET_BUSGRP,'OTHER') BUDG_BUS_GRP,
             -- CHAN.ORDER_CHANNEL,
     ...
     -- USE FOR CUSTOMER REPORTING
        /* INNER JOIN DW_FEI.CUSTOMER_DIMENSION CUST
            ...
            -- USE FOR REPORTING BUS GRP REPORTING 
         
           LEFT OUTER JOIN USER_SHARED.CUSTOMER_TO_BUSGRP BG
            ON  IHF.CUSTOMER_ACCOUNT_GK = BG.CUSTOMER_GK             
