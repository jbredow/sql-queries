SELECT SELL_DISTRICT,
  ...
  FROM (SELECT SLS.SELL_DISTRICT,
               ...
               --  SLS.MAIN_CUSTOMER_NK,
							 --CUST.CUSTOMER_GK,
               MAX(TO_NUMBER(CUST.MAIN_CUSTOMER_NK)) OVER(PARTITION BY SLS.SELL_ACCOUNT_NAME, CUST.CUSTOMER_NAME, SLS.SALESMAN_CODE)  CUST_DIM_MAIN,
         ...
         WHERE     TPD.FISCAL_YEAR_TO_DATE IN ('YEAR TO DATE', 'LAST YEAR TO DATE')
