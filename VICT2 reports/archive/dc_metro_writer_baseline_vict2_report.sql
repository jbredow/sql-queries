...
AS*/
   SELECT DISTINCT
          ...
          sum(sp_dtl.CORE_ADJ_AVG_COST) EX_CORE_COGS,
     ...
     FROM (SELECT SP_HIST.*, --process date changed to include invoice processing date
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK
                          ...
                          --AND ILF.
                          AND IHF.ACCOUNT_NUMBER IN '1300', '1888' --= 215
                          --AND IHF.WRITER = 'JPB'
                          ...
                          AND ILF.YEARMONTH BETWEEN '201804' AND '201809'
                          AND IHF.YEARMONTH BETWEEN '201804' AND '201809'
                          /*AND ILF.YEARMONTH =
