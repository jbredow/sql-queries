...
*/
DROP TABLE AAA6863.PR_VICT2_SKU_FITTINGS_6MO;

CREATE TABLE AAA6863.PR_VICT2_SKU_FITTINGS_6MO
	AS
	SELECT DISTINCT
	...
	LEFT OUTER JOIN 
		EBUSINESS.SALES_DIVISIONS SWD
			...
			/*	AND sp_dtl.ALT1_CODE IN (	'DR18BPX',
																	  'DR18BP12')
...
GRANT SELECT ON AAA6863.PR_VICT2_SKU_FITTINGS_6MO TO PUBLIC;