...
--   remove _NEW from PRICE_MGMT.PR_PRICE_CAT_HISTORY_NEW below after testing

      FROM PRICE_MGMT.PR_PRICE_CAT_HIST_2 HIST
      ...
      WHERE     TPD.ROLL12MONTHS IS NOT NULL
            AND SUBSTR (SWD.REGION_NAME, 0, 3) IN ('D01', 'D20',  'D98') -- 1350, 52, DIST
