SELECT 
       ...
       SUM ( MAIN.CORE_ADJ_AVG_COST ) CORE_ADJ_COGS,
  ...
  FROM ( SELECT IHF.ACCOUNT_NUMBER,
          ...
          WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK
                ...
                AND IHF.ACCOUNT_NUMBER = '5'  --IN ('20', '1480')
                ...
                AND IHF.PO_WAREHOUSE_NUMBER IS NULL
								AND IHF.YEARMONTH BETWEEN '201809' AND '201902'
								AND ILF.YEARMONTH BETWEEN '201809' AND '201902'
