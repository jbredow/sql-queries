  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          ...
                          AND IHF.ACCOUNT_NUMBER = '1657' --IN ( '448', '520', '1550', '3093', '226', '1657', '1674' )
                          ...
                          AND IHF.PO_WAREHOUSE_NUMBER IS NULL
													AND ILF.YEARMONTH BETWEEN '201408' AND '201504'
													AND IHF.YEARMONTH BETWEEN '201408' AND '201504'
