...
--used for the monthly showroom b_appliance report for fargo \ tami flowers

SELECT XXX.YEARMONTH,
	XXX.TYPE_OF_SALE,
	XXX.DISCOUNT_GROUP_NK,
	XXX.DISCOUNT_GROUP_NAME,
	XXX.PRICE_CATEGORY,
	XXX.PRICE_CATEGORY_OVR,
	SUM( XXX.EXT_SALES_AMOUNT ) SALES,
	SUM( XXX.EXT_AVG_COGS_AMOUNT ) AC
FROM (
	SELECT DISTINCT
