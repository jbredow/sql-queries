DROP TABLE AAA6863.OHVAL_WRITER;

CREATE TABLE AAA6863.OHVAL_WRITER
	...
	AS
		...
		WHERE ihf.CUSTOMER_ACCOUNT_GK = cust.CUSTOMER_GK
			...
			AND ILF.YEARMONTH IN (201208, 201209, 201210, 201211, 201212, 
				201301, 201302, 201304, 201305, 201306)
			AND IHF.YEARMONTH IN (201208, 201209, 201210, 201211, 201212, 
				201301, 201302, 201304, 201305, 201306)
			/* AND ILF.YEARMONTH =
