  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
													AND bc.ACCOUNT_NK = IHF.ACCOUNT_NUMBER
													--AND ILF.PRODUCT_STATUS = 'SP'
                          AND IHF.ACCOUNT_NUMBER IN (
																'226','448','520','1550','1657','1674','3093'
																)
                          ...
                          AND IHF.YEARMONTH = /*BETWEEN TO_CHAR (
                                 ...
                                 TO_CHAR (TRUNC (SYSDATE, 'MM') - 1,
                                          'YYYYMM')*/
													AND ILF.YEARMONTH BETWEEN '201411' AND '201412'
													AND IHF.YEARMONTH BETWEEN '201411' AND '201412'
					) SP_HIST
		...
		/*WHERE sp_dtl.ALT1_CODE IN (
								'GHS320','S50BIND','S50BCCP50','HHH2','HHT240','FRO9800','F2102FT',
								'F5050','A1603072','A1588400','A1573700','M2150HXLT01','M2150HLT01',
								'RAP90402','RAP90403','PSG16383PK','PSG16323','PSG16453','PFM90037',
								'PFM90037','WWF1GAL','H35284','H25515','O31133','PFXGCCDL','PFXGCCFL',
								'PFXGCCGL','PFXGCCHL','PFXGCCJL','PFXGCCKL','PFPCCD','PFPCCF','PFPCCG',
								'PFPCCH','PFPCCJ','PFPCCK','SHARKBITEPROMOVF','C19352','CTT75331CP',
								'CC5899CP','C19534','CTT7041CP')*/
			WHERE sp_dtl.DISCOUNT_GROUP_NK IN ('5538',' 5585')
		GROUP BY 
			sp_dtl.district,
       sp_dtl.ACCOUNT_NUMBER,
       sp_dtl.ACCOUNT_NAME,
