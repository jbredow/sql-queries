...
CREATE TABLE AAA6863.PR_VICT2_KRISTIN_HOGAN
AS
  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          ...
                          --      ('Q', 'N/A', 'R')
                          --AND IHF.WRITER = 'CMC'
                          --AND CUST.ACCOUNT_NAME IN ('LYONSOUTH')
						  ...
						  AND TRUNC (ihf.invoice_date) >=
										TRUNC (sysdate -4)  --changed to accept monday's sales too
	...
	/*WHERE  SP_DTL.DISCOUNT_GROUP_NAME IN ('1528',
										'1530',
										'1539',
										'3385',
										'4033',
			...
			AND  sp_dtl.WAREHOUSE_NUMBER IN('1121','1123','740','1177','1550','1124','1645','1643')*/
						;
