...
SELECT DISTINCT
		...
		sp_dtl.STATUS,
		sp_dtl.SHIPPED_QTY,
		sp_dtl.EXT_SALES_AMOUNT EX_SUM,
  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          ...
                          AND IHF.ACCOUNT_NUMBER IN ( 
																					...
																					'61',	'88',	'116',	'190',	'230',	'454',	'480',	'1869'
																					 )
                          --AND NVL (ILF.PRICE_CODE, 'N/A') IN
                          --      ('Q', 'N/A', 'R')
													AND CUST.CUSTOMER_NAME LIKE '%CASH%'
                          --AND IHF.WRITER = 'CMC'
                          ...
                          AND IHF.PO_WAREHOUSE_NUMBER IS NULL
													AND ILF.YEARMONTH BETWEEN '201501' AND '201505'
													AND IHF.YEARMONTH BETWEEN '201501' AND '201505'
     	...
     	/*WHERE sp_dtl.DISCOUNT_GROUP_NK IN (	'5234',	'5603',	'5580',	'5760',	'5569',	'5609',	'5590',	'5773',
			...
			WHERE sp_dtl.PRICE_COLUMN	IN ( '020', '021' )
