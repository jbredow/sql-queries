/*   VICT2 sql with updated rounding logic aligned with pricing cube
     ...
     set with date of previous 7 days */
	...
	FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          AND IHF.ACCOUNT_NUMBER IN ('448', '520', '1550', '1674', '226', '1020', '1657', '3093')
...
--############### DATE	
	...
	WHERE  sp_dtl.ALT1_CODE IN ('SSTST14440', 'SSTST19950', 'FTBIRLRG','FTBIRSM')
	;