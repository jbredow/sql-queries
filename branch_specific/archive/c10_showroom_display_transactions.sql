...
DROP TABLE AAA6863.PR_VICT2_CUST_FY_0314_D10_SHRM;

CREATE TABLE AAA6863.PR_VICT2_CUST_FY_0314_D10_SHRM
AS
SELECT DISTINCT
  ...
  FROM    (SELECT SP_HIST.*,
    ...
    where sp_dtl.ACCOUNT_NUMBER IN ('448',
                                    '520',
                                    '1550',
                                    '1674',
                                    '3093',
                                    ...
                                    '1020',
                                    '1657')
      AND sp_dtl.TYPE_OF_SALE IN ('Showroom', 'Showroom Direct')
      AND sp_dtl.CUSTOMER_NAME LIKE ('%DISPLAY%')
                             ;

GRANT SELECT ON AAA6863.PR_VICT2_CUST_FY_0314_D10_SHRM TO PUBLIC;