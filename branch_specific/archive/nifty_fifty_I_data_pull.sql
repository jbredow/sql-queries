             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          ...
                          --AND ILF.PRICE_CODE in ('R','N/A','Q')
													AND PROD.DISCOUNT_GROUP_NK IN ( '0143',
																													'0504',
																													'0505',
																													'0511',
																													'0513',
                          ...
                          AND IHF.YEARMONTH BETWEEN TO_CHAR (
                                 ...
                                 TO_CHAR (TRUNC (SYSDATE, 'MM') - 1,
                                          'YYYYMM')*/										
													--AND IHF.YEARMONTH=(SELECT PRIOR_YEARMONTH FROM SALES_MART.TIME_DIM)
													--AND ILF.YEARMONTH=(SELECT PRIOR_YEARMONTH FROM SALES_MART.TIME_DIM)
													AND IHF.YEARMONTH in ( '201411', '201412' )
													AND ILF.YEARMONTH in ( '201411', '201412' )
											) SP_HIST
