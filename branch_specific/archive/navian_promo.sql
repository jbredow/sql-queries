  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK --AND ILF.PRODUCT_STATUS = 'SP'
                          AND IHF.ACCOUNT_NUMBER IN ( '448', '1657', '1674' )
                          ...
                          AND ILF.YEARMONTH BETWEEN '201411' AND '201411'
                          AND IHF.YEARMONTH BETWEEN '201411' AND '201411'
    ...
    WHERE sp_dtl.DISCOUNT_GROUP_NK IN ('5458', '5459', '5444' )
      --AND sp_dtl.INVOICE_NUMBER_NK IN ( 'CD134121-1', 'CD134121' )
      ;