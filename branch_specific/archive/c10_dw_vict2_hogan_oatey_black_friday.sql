...
CREATE TABLE AAA6863.PR_VICT2_HOGAN
AS
select * from (
SELECT DISTINCT
  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          ...
                          AND IHF.ACCOUNT_NUMBER IN('276','1020','1176',
										'1668','1669','3093','3094','1020',
										'1550','3093')
                  ...
                  LEFT OUTER JOIN (SELECT COD.BASIS,
                     ...
                     ON (    SP_HIST.PRODUCT_NK = PR_OVR.MASTER_PRODUCT
                         ...
                         AND SP_HIST.CUSTOMER_ACCOUNT_GK = PR_OVR.CUSTOMER_GK)) sp_dtl) oatey
    where oatey.discount_group_nk IN(1528,1530,1539,3385,4033,4086,4138,4165)
	;

GRANT SELECT ON AAA6863.PR_VICT2_HOGAN TO PUBLIC;