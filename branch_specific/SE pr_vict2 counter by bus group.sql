...
FROM (SELECT SP_HIST.*, --process date changed to include invoice processing date
      ...
      FROM (SELECT IHF.ACCOUNT_NUMBER,
            ...
            FROM DW_FEI.INVOICE_HEADER_FACT IHF,
                 ...
                 USER_SHARED.BG_CUSTTYPE_XREF BG_XREF
            ...
            WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK
                          ...
                          AND CUST.CUSTOMER_TYPE = BG_XREF.CUSTOMER_TYPE
                          ...
                          AND ILF.YEARMONTH BETWEEN '201810' AND TO_CHAR (TRUNC (SYSDATE, 'MM'), 'YYYYMM')
                          
                          AND IHF.YEARMONTH BETWEEN '201810' AND TO_CHAR (TRUNC (SYSDATE, 'MM'), 'YYYYMM')
                          /*
                          AND ILF.YEARMONTH =
