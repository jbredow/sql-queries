...
SELECT
	CASE
		WHEN V2.YEARMONTH BETWEEN '201410' AND '201509' THEN 'PREV_12MO'
		ELSE 'CURRENT_12M0'
	END
		TPD,
	V2.ACCOUNT_NAME,
	  ...
	  FROM    (SELECT SP_HIST.*,
               ...
               /* AND CUST.MAIN_CUSTOMER_NK IN  ( '16855',
							  ...
							  AND IHF.PO_WAREHOUSE_NUMBER IS NULL
								...
								AND ILF.YEARMONTH BETWEEN '201409' AND '201610' -- OR ILF.YEARMONTH BETWEEN '201508' AND '201605'
								AND IHF.YEARMONTH BETWEEN '201409' AND '201610' --  OR IHF.YEARMONTH BETWEEN '201508' AND '201605'
