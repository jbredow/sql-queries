...
SELECT DISTINCT
		...
		CASE
			WHEN sp_dtl.YEARMONTH BETWEEN '201305' AND '201404'
			THEN 'PREVIOUS'
			WHEN sp_dtl.YEARMONTH BETWEEN '201405' AND '201504'
			THEN 'CURRENT'
		END
			PERIOD
  FROM    (SELECT SP_HIST.*,
     	...
     	WHERE sp_dtl.DISCOUNT_GROUP_NK 		IN (	'0504', '0505', '0513', '0525' )
				  AND sp_dtl.PRICE_COLUMN				IN ( '001', '002', '003', '006', '007', '008', '021', '070', '071', '072', '073', '089' )
