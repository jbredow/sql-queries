...
--DROP TABLE AAD9606.PR_VICT2_MIDATLWW_TEST2;

--CREATE TABLE AAD9606.PR_VICT2_MIDATLWW_TEST2
--AS
  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
													...
													AND CUST.MAIN_CUSTOMER_NK IN ('105875', '104301', '19859', '34' )
                          AND IHF.ACCOUNT_NUMBER IN ( '61', '190', '1869', '454' )
