...
SELECT DISTINCT
		...
		/*sp_dtl.STATUS,
		sp_dtl.SHIPPED_QTY,*/
		SUM ( sp_dtl.EXT_SALES_AMOUNT ) EX_SUM,
  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          ...
                          AND IHF.ACCOUNT_NUMBER IN ( '61', '480' ) --IN ( '448', '520', '1550', '3093', '226', '1657', '1674' )
                          ...
                          --AND ILF.PRICE_CODE in ('R','N/A','Q')
													AND CUST.MAIN_CUSTOMER_NK IN ( '211746', '28631' )
                          ...
                          AND IHF.PO_WAREHOUSE_NUMBER IS NULL
													/*AND ILF.YEARMONTH BETWEEN '201410' AND '201412'
													AND IHF.YEARMONTH BETWEEN '201410' AND '201412'*/
     	...
     	/*WHERE sp_dtl.DISCOUNT_GROUP_NK IN (	'5234',	'5603',	'5580',	'5760',	'5569',	'5609',	'5590',	'5773',
																					'5235',	'5604',	'5581',	'5764',	'5570',	'5611',	'5591',	'5778',
																					'5237',	'5605',	'5584',	'5769',	'5571',	'5615',	'5592',	'5780',
																					'5238',	'5606',	'5586',	'5770',	'5572',	'5616',	'5593',	'5782',
																					'5239',	'5607',	'5588',	'5771',	'5573',	'5617',	'5594',	'5783',
																					'5240',	'5608',	'5589',	'5772',	'5574',	'5696',	'5595',	'5785',
																					'5787',	'5575',	'5759',	'5600',	'5786'	)	*/
			--WHERE sp_dtl.DISCOUNT_GROUP_NK = '1072'
			GROUP BY
					sp_dtl.ACCOUNT_NUMBER,
					sp_dtl.ACCOUNT_NAME,
					/*sp_dtl.WAREHOUSE_NUMBER,
