...
SELECT DISTINCT
		CASE
			WHEN sp_dtl.YEARMONTH BETWEEN '201308' AND '201401' THEN 'BASELINE'
			WHEN sp_dtl.YEARMONTH BETWEEN '201408' AND '201501' THEN 'CURRENT'
			ELSE 'JUNK'
		END
			TIME_PERIOD,
  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          ...
                          AND IHF.ACCOUNT_NUMBER IN ( '61',	'88',	'116',	'190',	'230',	'454',	'480',	'1869' )
     	...
     	WHERE sp_dtl.DISCOUNT_GROUP_NK IN (	'2299', 	'3211', 	'3214', 	'3215', 	'3218', 	'3226', 	'3740',
																					'3741', 	'3742', 	'3743', 	'3744', 	'3746', 	'3748', 	'3749',
