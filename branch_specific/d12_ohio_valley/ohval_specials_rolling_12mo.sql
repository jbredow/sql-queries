--change the months used at end of query

SELECT SP.YEARMONTH,	
      SP.ACCOUNT_NUMBER,	
      SP.WRITER,	
      SP.STATUS, 
      SUM (SP.EXT_SALES_AMOUNT) EXT_SLS, 
      SUM (SP.EXT_AVG_COGS_AMOUNT) EXT_AC
FROM (
	SELECT DISTINCT
		sp_dtl.YEARMONTH,
	...
	FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          ...
                          --      ('Q', 'N/A', 'R')
                          --AND IHF.WRITER = 'CMC'
                          --AND CUST.ACCOUNT_NAME IN ('DULUTH')
	...
	WHERE sp_dtl.STATUS IN ('SP','SP-')) SP
-------------------- change dates covered in report...
  WHERE sp.yearmonth IN('201311','201310','201309','201308')

GROUP BY SP.YEARMONTH,	
      SP.ACCOUNT_NUMBER,	
      SP.WRITER,	
      SP.STATUS

ORDER BY SP.YEARMONTH,	
      SP.ACCOUNT_NUMBER,	
      SP.WRITER,	
      SP.STATUS
;
