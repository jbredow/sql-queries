  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          ...
                          --      ('Q', 'N/A', 'R')
													AND IHF.WAREHOUSE_NUMBER IN ( '391', '1147', '1626', '2922' )
                          --AND IHF.WRITER = 'CMC'
                          ...
                          --AND ILF.PRICE_CODE in ('R','N/A','Q')
                              ...
                              '5234',	'5235',	'5239',	'5569',	'5570',	'5571',
                              '5572',	'5573',	'5584',	'5590',	'5603',	'5604',
                              '5605',	'5606',	'5607',	'5608',	'5609',	'5611',
                              '5696',	'5759',	'5764',	'5770',	'5773',	'5778',
                              '5780',	'5782',	'5783',	'5785',	'5786',	'5787')
                          ...
                          AND IHF.YEARMONTH BETWEEN TO_CHAR (
                                 ...
                                 TO_CHAR (TRUNC (SYSDATE, 'MM') - 1,
                                          'YYYYMM')*/										
													--AND IHF.YEARMONTH=(SELECT CY_FISCAL_YEAR FROM SALES_MART.TIME_DIM)
													--AND ILF.YEARMONTH=(SELECT CY_FISCAL_YEAR FROM SALES_MART.TIME_DIM)
													AND IHF.YEARMONTH BETWEEN  '201401' AND '201412' 
													AND ILF.YEARMONTH BETWEEN  '201401' AND '201412'
											) SP_HIST
