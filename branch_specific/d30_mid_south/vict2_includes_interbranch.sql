/*
  for Andrew Robison
  includes interbranch for specific writers
*/
...
FROM (SELECT SP_HIST.*, --process date changed to include invoice processing date
      ...
      FROM (SELECT IHF.ACCOUNT_NUMBER,
            ...
            WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK
                          ...
                          AND IHF.ACCOUNT_NUMBER IN ( '2000',
                                                      '1430',
                                                       '501',
                                                      '1480',
                                                      '2735'
                                                      )
                          AND IHF.WRITER IN ( 'CJI',
                                              'MCS',
                                              'MS'
                                              )
                          ...
                          AND ILF.YEARMONTH BETWEEN '201808' AND '201904'
                          AND IHF.YEARMONTH BETWEEN '201808' AND '201904'
