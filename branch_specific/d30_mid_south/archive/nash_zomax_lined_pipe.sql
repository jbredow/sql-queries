...
SELECT DISTINCT
	...
	CASE 
		WHEN 
			sp_dtl.PRICE_CATEGORY_OVR IS NOT NULL 
		THEN 
	...
	CASE 
		WHEN 
			sp_dtl.PRICE_CATEGORY_OVR IS NOT NULL 
		THEN 
			sp_dtl.PR_OVR_BASIS ELSE NULL 
	END PR_OVR_BASIS,
	CASE 
		WHEN 
			sp_dtl.PRICE_CATEGORY_OVR IS NOT NULL 
		THEN 
			sp_dtl.GR_OVR ELSE NULL 
	END GR_OVR,
	sp_dtl.TRIM_FORM,
	sp_dtl.ORDER_CODE,
...
FROM (SELECT IHF.ACCOUNT_NUMBER,
	...
	END
                    ...
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          ...
                          --      ('Q', 'N/A', 'R')
                          --AND IHF.WRITER = 'CMC'
                          AND CUST.ACCOUNT_NAME IN ('NASH', 'OHVAL')
		...
		WHERE DISCOUNT_GROUP_NK IN ('5853',
									'5854',
									'0876',
									'0552',
									'0554',
