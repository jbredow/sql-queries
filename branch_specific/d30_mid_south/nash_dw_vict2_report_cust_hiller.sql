--andy ethridge customer report for hiller
  ...
  FROM    (SELECT SP_HIST.*,
             ...
             IHF.YEARMONTH,
                    ...
                    WHERE IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK --AND ILF.PRODUCT_STATUS = 'SP'
                          AND IHF.ACCOUNT_NUMBER IN ( '20', '13')
                          ...
                          --AND IHF.REF_BID_NUMBER='B225888'
													--AND CUST.CUSTOMER_NK = '12388'
                          AND CUST.CUSTOMER_NK IN ( '22521', '22485', '34016', '112114',
																										'112115', '112116', '112117', '115543', 
																										'62911', '80109', '12388' )
