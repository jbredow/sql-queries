...
DROP TABLE AAA6863.TESTER;

CREATE TABLE AAA6863.CHI_TRANS_MAY_DEC13
AS
SELECT DISTINCT
  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          ...
                          --      ('Q', 'N/A', 'R')
                          --AND IHF.WRITER = 'CMC'
                          AND CUST.ACCOUNT_NAME IN ('CHICAGO')
...
GRANT SELECT ON AAA6863.CHI_TRANS_MAY_DEC13 TO PUBLIC;