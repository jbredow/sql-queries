  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          ...
                          AND IHF.ACCOUNT_NUMBER IN ( '448', '520', '1550', '3093', '226', '1657', '1674', '1020' )
                          ...
                          AND IHF.PO_WAREHOUSE_NUMBER IS NULL
													AND ILF.YEARMONTH BETWEEN '201504' AND '201506'
													AND IHF.YEARMONTH BETWEEN '201504' AND '201506'
			...
			WHERE sp_dtl.DISCOUNT_GROUP_NK IN ( '1999', '2000' )
			GROUP BY
						sp_dtl.ACCOUNT_NUMBER,
						sp_dtl.ACCOUNT_NAME,
						sp_dtl.WAREHOUSE_NUMBER,
