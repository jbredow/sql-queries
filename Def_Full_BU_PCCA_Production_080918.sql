          ...
          FROM (SELECT DISTINCT
                  ...
                  FROM DW_FEI.CUSTOMER_DIMENSION CUST
					   ...
					   LEFT OUTER JOIN DW_FEI.JOBS_FACT JOBS
						  ON JOBS.CUSTOMER_GK = CUST.CUSTOMER_GK
          --LEFT OUTER JOIN AAD9606.PR_CTYPE_COLUMN_XREF_V PC_CT_XREF2
                       LEFT OUTER JOIN AAD9606.PR_CTYPE_COLUMN_XREF_NEW PC_CT_XREF2
                 ...
                 WHERE (CUST.DELETE_DATE IS NULL)
                       ...
                       --This is the area where you fill in your own parameters
                       AND CUST.ACCOUNT_NAME NOT LIKE 'INT%'
                       AND CUST.ACCOUNT_NUMBER_NK IN ('5', '107', '34', '501', '1300', '1196')
                       --AND CUST.SALESMAN_CODE = 'RFD'
                       --AND CUST.PRICE_COLUMN IN ('301', '302', '303', '304', '306', '307', '308', '309')
