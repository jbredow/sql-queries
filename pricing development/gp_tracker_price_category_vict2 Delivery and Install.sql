TRUNCATE TABLE AAA6863.PR_VICT2_FYTD_DEL_INSTALL;
DROP TABLE AAA6863.PR_VICT2_FYTD_DEL_INSTALL;

CREATE TABLE AAA6863.PR_VICT2_FYTD_DEL_INSTALL
            ...
            THEN 
                'NDP'
                 ...
                 WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK
                       ...
                       AND ILF.YEARMONTH BETWEEN '201708' AND TO_CHAR (TRUNC (SYSDATE, 'MM') - 1, 'YYYYMM')
                       AND IHF.YEARMONTH BETWEEN '201708' AND TO_CHAR (TRUNC (SYSDATE, 'MM') - 1, 'YYYYMM')
								)
               SP_HIST
...
SELECT * FROM AAA6863.PR_VICT2_FYTD_DEL_INSTALL;