...
AS
   SELECT SWD.DIVISION_NAME AS REGION,
          ...
          END
             AS PILOT_PROD,
          CASE
             WHEN DTL.ACCOUNT_NUMBER IN ('1196', '501')
             THEN
                (CASE
                    WHEN TO_CHAR (DTL.PROCESS_DATE, 'YYYYMM') BETWEEN '201706'
                                                                  AND '201805'
                    THEN
                       '2017AVG'
                    ELSE
             ...
             ELSE
                (CASE
                    ...
                    THEN
                       '2017AVG'
                    WHEN TO_CHAR (DTL.PROCESS_DATE, 'YYYYMM') BETWEEN '201803'
                                                                  AND '201805'
                    THEN
                       '90DAYPILOT'
                    ELSE
          ...
          CASE
             ...
             THEN
                (CASE
                    WHEN DTL.PROCESS_DATE >= '07/01/2018' THEN 'Y'
                    ELSE 'N'
                 END)
             ELSE
                (CASE
                    WHEN DTL.PROCESS_DATE >= '03/01/2018' THEN 'Y'
                    ELSE 'N'
                 END)
          END
             AS PILOT_LIVE,
