...
FROM (SELECT GP_SUMS.YEARMONTH,
             ...
             GP_SUMS.SLS_SUBTOTAL
                "Sales, Sub-Total",
             GP_SUMS.SLS_OUTBOUND - GP_SUMS.SLS_SUBTOTAL
                "Outbound Diff",
             GP_SUMS.SLS_FREIGHT
                "Sales, Freight",
             GP_SUMS.SLS_MISC
             ...
             GP_SUMS.TOTAL_COST
                "Total Cost",
             GP_SUMS.COST_SUBTOTAL
                "Cost, Sub-Total",
             GP_SUMS.COST_FREIGHT
                "Cost, Freight",
             GP_SUMS.COST_MISC
                "Cost, Misc",
             GP_SUMS.TOTAL_GP
             ...
             ROUND (
                ...
                6)
                "Price Matrix Profit%$",
             GP_SUMS.MATRIX_LINES
                "Price Matrix # Lines",
             GP_SUMS.CONTRACT_SALES
                "Contract Sales",
             GP_SUMS.CONTRACT_COST
                "Contract Cost",
             GP_SUMS.CONTRACT_GP
                "Contract GP$",
             ROUND (
             ...
             ROUND (
                ...
                6)
                "Contract Profit%$",
             GP_SUMS.CONTRACT_LINES
                "Contract # Lines",
             GP_SUMS.MANUAL_SALES
                "Manual Sales",
             GP_SUMS.MANUAL_COST
                "Manual Cost",
             GP_SUMS.MANUAL_GP
             ...
             ROUND (
                ...
                6)
                "Credits Use%#",
             GP_SUMS.FREIGHT_PROFIT_LOSS
                "Freight Profit (Loss)",
             GP_SUMS.SLS_OUTBOUND
                "Outbound Sales"
      FROM (SELECT ' YTD'
                      YEARMONTH,
                   CASE
                ...
                --|| NVL (GP_DATA.WRITER, '#N/A')
                   ...
                   SUM (
                      ...
                      END)
                      SLS_OUTBOUND,
                   SUM (GP_DATA.SLS_FREIGHT)
                      SLS_FREIGHT,
                   SUM (GP_DATA.SLS_MISC)
                      SLS_MISC,
                   SUM (GP_DATA.SLS_RESTOCK)
                      SLS_RESTOCK,
                   SUM (
                      ...
                      TOTAL_COST,
                   SUM (GP_DATA.AVG_COST_SUBTOTAL)
                      COST_SUBTOTAL,
                   SUM (GP_DATA.AVG_COST_FREIGHT)
                      COST_FREIGHT,
                   SUM (GP_DATA.AVG_COST_MISC)
                      COST_MISC,
                   SUM (
                        (  GP_DATA.SLS_SUBTOTAL
                         + GP_DATA.SLS_FREIGHT
            ...
            GROUP BY                                      --GP_DATA.YEARMONTH,
                     ...
                     END                                                   --,
                        ...
                        --ACCT.ACCOUNT_NAME--,
                        --GP_DATA.WRITER
                        ) GP_SUMS--WHERE WRITER_INIT NOT IN '#N/A'
                                 )
