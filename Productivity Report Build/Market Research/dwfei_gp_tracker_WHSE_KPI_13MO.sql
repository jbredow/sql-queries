--ADD IN THE DISTRICT FROM THE SALES_MART.SALES_WAREHOUSE_DIM
--ADD IN THE TYPE OF SALE IN YOUR VIEW
...
MM,
YEARMONTH,
ROUND("Total Sales",0) "Total Sales",
ROUND("Sales, Sub-Total",0) "Sales, Sub-Total",
...
--GP_DATA.ROLLUP,
  ...
  FROM AAA6163.GP_TRACKER_13MO GP_DATA,
