--PRICE_MGMT.GP_TRACKER_KPI_12MO
...
SELECT GP_DATA.YEARMONTH,
       ...
       WD.ACCOUNT_NAME,
       NVL (GP_DATA.WAREHOUSE_NUMBER_NK, NULL) WHSE_NK,
       GP_DATA.REGION 
       || '*'
       || GP_DATA.ACCOUNT_NUMBER
       || '*'
  ...
  FROM PRICE_MGMT.GP_TRACKER_KPI_12MO GP_DATA,
...
GROUP BY GP_DATA.YEARMONTH,
         ...
         GP_DATA.ACCOUNT_NUMBER,
         WD.ACCOUNT_NAME,
         NVL (GP_DATA.WAREHOUSE_NUMBER_NK, NULL)
