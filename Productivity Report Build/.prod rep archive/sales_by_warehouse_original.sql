SELECT 
	...
	ROUND (
		...
		/ SUM (
				CASE	
					WHEN GP_DATA.SLS_SUBTOTAL + GP_DATA.SLS_FREIGHT + GP_DATA.SLS_MISC + GP_DATA.SLS_RESTOCK > 0
					THEN GP_DATA.SLS_SUBTOTAL + GP_DATA.SLS_FREIGHT + GP_DATA.SLS_MISC + GP_DATA.SLS_RESTOCK
					ELSE 1
			END),
		3)
		"Total GP%",
   ...
   ROUND (
	...
	SUM (GP_DATA.SLS_FREIGHT - GP_DATA.AVG_COST_FREIGHT)
		...
		FROM  AAK9658.GP_TRACKER_WRITER GP_DATA,  --Trevor's Schema
