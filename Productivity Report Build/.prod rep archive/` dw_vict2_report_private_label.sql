...
DROP TABLE AAA6863.PR_VICT2_PRIVATE_LABEL;

CREATE TABLE AAA6863.PR_VICT2_PRIVATE_LABEL
AS
SELECT DISTINCT
		...
		CASE 
			...
			THEN sp_dtl.PR_OVR ELSE NULL 
		END PR_OVR,
		CASE 
			WHEN sp_dtl.PRICE_CATEGORY_OVR IS NOT NULL 
			THEN sp_dtl.PR_OVR_BASIS ELSE NULL 
		END PR_OVR_BASIS,
		CASE 
			WHEN sp_dtl.PRICE_CATEGORY_OVR IS NOT NULL 
			THEN sp_dtl.GR_OVR ELSE NULL 
		END GR_OVR,
		sp_dtl.TRIM_FORM,
		sp_dtl.ORDER_CODE,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                     ...
                     FROM DW_FEI.INVOICE_HEADER_FACT IHF,
                          ...
                          DW_FEI.SPECIAL_PRODUCT_DIMENSION SP_PROD,
						              AAA6863.MICH_CUST_LIST MI_CUST
							
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
						  --AND ILF.PRODUCT_STATUS = 'SP'
                          --AND IHF.ACCOUNT_NUMBER = '2000'
                          AND MI_CUST.CUST_NK = CUST.CUSTOMER_NK
						  ...
						  AND PROD.ALT1_CODE IN ('PF92341','PF92352','Z53001')
                          ...
                          AND ILF.YEARMONTH = '201203'
                          AND IHF.YEARMONTH = '201203'
						  ) SP_HIST
...
GRANT SELECT ON AAA6863.PR_VICT2_PRIVATE_LABEL TO PUBLIC;