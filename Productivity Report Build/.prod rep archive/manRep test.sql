...
END "GP %",
	...
	man.account_number || '^' || man.invoice_number_nk || '^' || man.invoice_line_number CAT
FROM	AAA6863.pr_vict2_cust_12mo_ln man
...
WHERE man.price_category  IN ('TOOLS', 'MANUAL', 'QUOTE')
	...
	AND man.account_number IN ('13', '1480')  	/* remove after testing */
	AND UPPER(bc.rpc) IN 'MIDWEST'	
