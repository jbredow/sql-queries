--DROP TABLE AAD9606.PR_SP_DETAIL_LM;

--CREATE TABLE AAD9606.PR_SP_DETAIL_LM
  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK --AND ILF.PRODUCT_STATUS = 'SP'
                          AND IHF.ACCOUNT_NUMBER = '1480' --AND NVL(ILF.PRICE_CODE,'N/A') in ('Q','N/A','R')
...
--GRANT SELECT ON AAD9606.PR_SP_DETAIL_LM TO PUBLIC;