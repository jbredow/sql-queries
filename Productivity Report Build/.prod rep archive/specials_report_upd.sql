 ...
 WHERE SP.STATUS IN ('SP-', 'SP') 
       ...
       AND ((SUBSTR (SWD.REGION_NAME, 1, 3) IN
                  ('D10',
                   ...
                   'D51',
                   'D53')) 
						OR SP.warehouse_number = '5350')
ORDER BY SP.account_number ASC, SP.discount_group_nk ASC, SP.alt1_code ASC
