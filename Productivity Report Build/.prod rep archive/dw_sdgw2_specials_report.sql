-- updated rounding logic aligned with pricing cube
-- 10/7/2013, Leigh North

DROP TABLE AAA6863.PR_SDGW2_CUST;

CREATE TABLE AAA6863.PR_SDGW2_CUST
	AS
SELECT DISTINCT
  ...
  FROM    (SELECT SP_HIST.*,
		 ...
		 FROM (SELECT IHF.ACCOUNT_NUMBER,
				...
				WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
					  ...
					  --AND IHF.ACCOUNT_NUMBER = '520' --cedar
...
GRANT SELECT ON AAA6863.PR_SDGW2_CUST TO PUBLIC;