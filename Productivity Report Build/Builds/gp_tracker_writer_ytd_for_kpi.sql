TRUNCATE TABLE PRICE_MGMT.GP_TRACKER_WRITER_YTD;
DROP TABLE PRICE_MGMT.GP_TRACKER_WRITER_YTD;

CREATE TABLE PRICE_MGMT.GP_TRACKER_WRITER_YTD
NOLOGGING
   ...
   ps.division_name REGION,
    ...
    ps.division_name,
             ...
             DECODE (ihf.SALE_TYPE,
                     ...
                     '7', 'Showroom Direct',
                     '8', 'eBusiness'));
                     GRANT SELECT ON PRICE_MGMT.GP_TRACKER_WRITER_YTD TO PUBLIC;
