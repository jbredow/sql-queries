TRUNCATE TABLE PRICE_MGMT.PR_VICT2_BG_12MO;
DROP TABLE PRICE_MGMT.PR_VICT2_BG_12MO;

CREATE TABLE PRICE_MGMT.PR_VICT2_BG_12MO NOLOGGING
AS
SELECT DISTINCT
          sp_dtl.YEARMONTH,
     ...
     FROM (SELECT SP_HIST.*, --process date changed to include invoice processing date
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK
                          ...
                          --AND ILF.
                          --AND IHF.ACCOUNT_NUMBER IN ('20','1480')
                          --AND IHF.WRITER = 'JPB'
...
GRANT SELECT ON PRICE_MGMT.PR_VICT2_BG_12MO TO PUBLIC;