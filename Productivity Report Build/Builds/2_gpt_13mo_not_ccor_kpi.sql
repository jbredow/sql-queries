TRUNCATE TABLE PRICE_MGMT.GP_TRACKER_KPI_12MO_NOT_CCOR;
DROP TABLE PRICE_MGMT.GP_TRACKER_KPI_12MO_NOT_CCOR;

CREATE TABLE PRICE_MGMT.GP_TRACKER_KPI_12MO_NOT_CCOR
NOLOGGING
...
AS
   (SELECT SUBSTR (ihf.YEARMONTH, 0, 4) YYYY,
           ...
           SUM (CASE WHEN ilf.SHIPPED_QTY > 0 THEN 1 ELSE 0 END)
              invoice_lines,
           SUM (ILF.CORE_ADJ_AVG_COST) core_avg_cogs,
