...
CREATE TABLE AAE0376.GP_TRACKER_WRITER
...
AS
   (SELECT 
           ...
           COUNT (DISTINCT (CASE WHEN LINE_HIST.INVOICE_NUMBER_NK NOT IN ('CM%', '%-%') THEN LINE_HIST.INVOICE_NUMBER_NK ELSE NULL END)) OVER (PARTITION BY LINE_HIST.YEARMONTH, LINE_HIST.REGION, LINE_HIST.ACCOUNT_NUMBER, LINE_HIST.WAREHOUSE_NUMBER, LINE_HIST.WRITER, LINE_HIST.TYPE_OF_SALE) INVOICE_CNT,
          /* CASE
   ...
   (SELECT 
           ...
           DECODE (ihf.SALE_TYPE,
              ...
              TYPE_OF_SALE,
              CASE
              WHEN IHF.INVOICE_NUMBER_NK NOT IN ('CM%', '%-%')THEN (COUNT (DISTINCT IHF.INVOICE_NUMBER_NK)) ELSE 0 END INVOICE_CNT,
