DROP TABLE AAE0376.GP_TRACKER_13MO_CCOR;


CREATE TABLE AAE0376.GP_TRACKER_13MO_CCOR
...
(SELECT LINE_HIST.YYYY,
        ...
        CASE
           WHEN LINE_HIST.ORDER_ENTRY_DATE BETWEEN NVL (
           ...
           THEN
              CASE
                 ...
                 THEN
                    CASE
                       WHEN LINE_HIST.UNIT_NET_PRICE_AMOUNT = PR_OVR.MULTIPLIER
                                                                      
                          THEN
                             'OVERRIDE'
                          WHEN LINE_HIST.UNIT_NET_PRICE_AMOUNT=   ROUND (PR_OVR.
                                                                       MULTIPLIER, 2)
                            THEN
                             'OVERRIDE'
                          WHEN LINE_HIST.UNIT_NET_PRICE_AMOUNT=   (TRUNC (PR_OVR.
                                                                       MULTIPLIER, 2) + .01)
                            THEN
                             'OVERRIDE'
                            WHEN LINE_HIST.UNIT_NET_PRICE_AMOUNT=   (TRUNC (PR_OVR.
                            ...
                            THEN
                             'OVERRIDE'
                              WHEN LINE_HIST.UNIT_NET_PRICE_AMOUNT=   (FLOOR (PR_OVR.
                                                                       MULTIPLIER)+1)
                            THEN
                             'OVERRIDE'
   ...
   FROM (SELECT SUBSTR (ihf.YEARMONTH, 0, 4) YYYY,
          ...
          WHERE ihf.CUSTOMER_ACCOUNT_GK = cust.CUSTOMER_GK
                ...
                AND NVL (ilf.PRICE_CODE,'N/A') IN ('R','Q','N/A')
          ...
          CASE
             ...
             THEN
                CASE
                   WHEN LINE_HIST.PRICE_CODE IN ('R', 'N/A', 'Q')
                   THEN
                      CASE WHEN LINE_HIST.UNIT_NET_PRICE_AMOUNT = PR_OVR.
                                                                       MULTIPLIER
