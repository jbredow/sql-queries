...
--       VICT2.DELIVERY_CHANNEL,
       ...
       SUM (
          CASE
             WHEN VICT2.PRICE_CATEGORY IN ('OVERRIDE') THEN VICT2.LINES
             ELSE 0
          END)
          OVERRIDE_LINES,
       SUM (
       ...
       SUM (
          CASE
             WHEN VICT2.PRICE_CATEGORY IN ('SPECIALS')
             THEN
                VICT2.CORE_ADJ_AVG_COGS
             ELSE
                0
       ...
       SUM (
          CASE
             WHEN VICT2.PRICE_CATEGORY <> 'CREDITS'
             THEN
                VICT2.CORE_ADJ_AVG_COGS
             ELSE
                0
