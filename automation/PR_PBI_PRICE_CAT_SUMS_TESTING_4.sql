TRUNCATE TABLE PRICE_MGMT.PR_PBI_PRICE_CAT_SUMS_4TH;


   DROP TABLE PRICE_MGMT.PR_PBI_PRICE_CAT_SUMS_4TH;

   CREATE TABLE PRICE_MGMT.PR_PBI_PRICE_CAT_SUMS_4TH
   NOLOGGING
   AS
