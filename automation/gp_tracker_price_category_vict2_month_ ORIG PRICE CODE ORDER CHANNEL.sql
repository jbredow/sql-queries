...
TRUNCATE TABLE AAA6863.PR_VICT2_CUST_201811;
DROP TABLE AAA6863.PR_VICT2_CUST_201811;

CREATE TABLE AAA6863.PR_VICT2_CUST_201811
NOLOGGING
AS
   SELECT DISTINCT
          sp_dtl.YEARMONTH,
   ...
   FROM (SELECT SP_HIST.*, --process date changed to include invoice processing date
         ...
         FROM (SELECT IHF.ACCOUNT_NUMBER,
               ...
               WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK
                     ...
                     AND ILF.YEARMONTH = '201811'
                     AND IHF.YEARMONTH = '201811'/*AND ILF.YEARMONTH =
...
GRANT SELECT ON AAA6863.PR_VICT2_CUST_201811 TO PUBLIC;