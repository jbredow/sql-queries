TRUNCATE TABLE PRICE_MGMT.PR_PBI_PRICE_CAT_SUMS_2ND;

   DROP TABLE PRICE_MGMT.PR_PBI_PRICE_CAT_SUMS_2ND;

   CREATE TABLE PRICE_MGMT.PR_PBI_PRICE_CAT_SUMS_2ND
   NOLOGGING
   AS
