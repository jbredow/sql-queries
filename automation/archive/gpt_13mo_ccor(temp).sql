...
CREATE TABLE AAA6863.PR_PRICE_CAT_HIST_CCOR_07
...
AS
   ...
   SELECT --LINE_HIST.YYYY,
          ...
          SUM (LINE_HIST.EXT_AVG_COGS_AMOUNT) EXT_AVG_COGS_AMOUNT,
          SUM (LINE_HIST.CORE_ADJ_AVG_COST) CORE_ADJ_AVG_COST,
          SUM (LINE_HIST.EXT_ACTUAL_COGS_AMOUNT) EXT_ACTUAL_COGS_AMOUNT,
          SUM (LINE_HIST.EXT_SALES_AMOUNT) EXT_SALES_AMOUNT,
          --LINE_HIST.REGION,
