TRUNCATE TABLE PRICE_MGMT.PR_PBI_PRICE_CAT_SUMS_1ST;

DROP TABLE PRICE_MGMT.PR_PBI_PRICE_CAT_SUMS_1ST;

CREATE TABLE PRICE_MGMT.PR_PBI_PRICE_CAT_SUMS_1ST
NOLOGGING
AS
   SELECT HIST.EOM_YEARMONTH,
          ...
          CASE
             ...
             WHEN CTS.R12M_NET_BILLINGS_AMT > = 4000 THEN CUST.CUSTOMER_NAME
   ...
   WHERE TPD.ROLL12MONTHS IS NOT NULL AND TPD.FISCAL_QTR = 'FIRST'
