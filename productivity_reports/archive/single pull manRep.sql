/*  Used as single pull manual report data (vict2) for 
	BCM Counter reporting includes Manual Report, PCCA (modified),
	Counter Writer, Counter GP Tracker.  */
SELECT * FROM
SELECT 	
		...
		/* ROUND(ilf.ext_avg_cogs_amount / ilf.shipped_qty, 2) "Unit AC",
		ROUND(( ilf.unit_net_price_amount - ilf.ext_avg_cogs_amount)/
			ilf.unit_net_price_amount,3) "GP %",
		ROUND(ilf.unit_net_price_amount - ilf.matrix_price, 2) "Matrix Var", */
		sp_dtl.MATRIX_PRICE,
  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
              ...
              /*AND IHF.ACCOUNT_NUMBER IN (
							...
							'420', '564', '216', '1869', '116', '61', '190', '480',
							'230', '454', '88', '1895', '788', '1116', '1105', '1221',
							'1616', '2721', '3083', '8423', '2637', '1701', '1423',
							'3011', '1539', '1083', '1600', '1934', '1491', '1476')*/
/*  single branch  */
              AND IHF.ACCOUNT_NUMBER = '3205'
