/*full report
	drop table to aaa6863 schema for subsequent query's
	added customer_gk and yearmonth on 7.12.13 */

DROP TABLE AAA6863.PR_VICT2_CUST_12MO_UPDATED;

CREATE TABLE AAA6863.PR_VICT2_CUST_12MO_UPDATED
AS
...
SELECT	sp_dtl.ACCOUNT_NUMBER,
		...
		sp_dtl.WRITER,
		sp_dtl.WR_FL_INI,
		NVL (sp_dtl.ASSOC_NAME, emp.ASSOC_NAME) AS ASSOC_NAME,
		sp_dtl.SALESREP_NK,
...
GRANT SELECT ON AAA6863.PR_VICT2_CUST_12MO_UPDATED TO PUBLIC;