/* specific customer or branch, etc. */
...
SELECT sp_dtl.ACCOUNT_NUMBER ACCT,
  ...
  FROM    (SELECT SP_HIST.*,
       ...
       ON sp_dtl.ACCOUNT_NAME = emp.ACCOUNT_NAME
		...
		LEFT OUTER JOIN DW_FEI.WAREHOUSE_DIMENSION WHSE
			ON AND WHSE.WAREHOUSE_GK = IHF.SHIP_FROM_WAREHOUSE_GK;
