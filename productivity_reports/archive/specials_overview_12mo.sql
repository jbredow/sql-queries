...
*/
DROP TABLE AAA6863.PR_SPECIALS_OVERVIEW_12MO;

CREATE TABLE AAA6863.PR_SPECIALS_OVERVIEW_12MO
	AS
	SELECT DISTINCT
	...
	FROM	(SELECT SP_HIST.*,
		...
		FROM (SELECT IHF.ACCOUNT_NUMBER,
					...
					WHERE IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
						...
						--AND IHF.ACCOUNT_NUMBER IN ( '61', '1500' )
...
GRANT SELECT ON AAA6863.PR_SPECIALS_OVERVIEW_12MO TO PUBLIC;