...
/*     POA_HDR.DRAWER,
       ...
       POA_LINE.LINE_NUMBER_NK,
			 ...
			 DW_FEI.BR_PAY_ON_ACCT_HEADER_FACT
 ...
 WHERE POA_LINE.INSERT_TIMESTAMP >= ADD_MONTHS( TRUNC (SYSDATE, 'mm'), -6)
       AND POA_LINE.INSERT_TIMESTAMP < TRUNC (SYSDATE, 'mm') -1
       AND (SWD.ACCOUNT_NUMBER_NK IN('20', '1440', '2000', '61'))

 GROUP BY SWD.DIVISION_NAME, -- AS REGION,
       SWD.REGION_NAME, -- AS DISTRICT,
/*     SWD.ACCOUNT_NUMBER_NK AS BRANCH_NK,
       SWD.ACCOUNT_NAME AS ALIAS,
       CUST.CUSTOMER_NK,
