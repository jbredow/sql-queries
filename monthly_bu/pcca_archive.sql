...
--DROP TABLE AAM1365.A_PCCA_CENT_201908;

CREATE TABLE AAM1365.A_PCCA_CENT_201908 NOLOGGING
AS
...
GRANT SELECT ON AAM1365.A_PCCA_CENT_201908 TO PUBLIC;

SELECT *
  FROM AAM1365.A_PCCA_CENT_201908 PCCA
 WHERE PCCA.DIST = 'D10';
