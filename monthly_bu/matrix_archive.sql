...
*/
DROP TABLE AAA6863.A_MATRIX_CENT_201512;

CREATE TABLE AAA6863.A_MATRIX_CENT_201512
	AS 
	(
	SELECT * FROM (
...
GRANT SELECT ON  AAA6863.A_MATRIX_CENT_201506 TO PUBLIC;

SELECT * FROM AAA6863.A_MATRIX_CENT_201512 WHERE DIST = 'D10';
SELECT * FROM AAA6863.A_MATRIX_CENT_201512 WHERE DIST = 'D11';
SELECT * FROM AAA6863.A_MATRIX_CENT_201512 WHERE DIST = 'D12';
SELECT * FROM AAA6863.A_MATRIX_CENT_201512 WHERE DIST = 'D14';
SELECT * FROM AAA6863.A_MATRIX_CENT_201512 WHERE DIST = 'D30';
SELECT * FROM AAA6863.A_MATRIX_CENT_201512 WHERE DIST = 'D31';
SELECT * FROM AAA6863.A_MATRIX_CENT_201512 WHERE DIST = 'D32';
SELECT * FROM AAA6863.A_MATRIX_CENT_201512 WHERE DIST = 'D50';
SELECT * FROM AAA6863.A_MATRIX_CENT_201512 WHERE DIST = 'D51';
SELECT * FROM AAA6863.A_MATRIX_CENT_201512 WHERE DIST = 'D53';

-- SELECT * FROM AAA6863.A_MATRIX_CENT_201512 WHERE DIST IN ( 'D50', 'D51', 'D53' );
