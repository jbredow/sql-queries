...
*/
--DROP TABLE AAM1365.A_MATRIX_CENT_201902;

CREATE TABLE AAM1365.A_MATRIX_CENT_201902 NOLOGGING
	AS 
	(
	SELECT * FROM (
...
GRANT SELECT ON  AAM1365.A_MATRIX_CENT_201902 TO PUBLIC;

SELECT * FROM AAM1365.A_MATRIX_CENT_201902 WHERE DIST = 'D10';
SELECT * FROM AAM1365.A_MATRIX_CENT_201902 WHERE DIST = 'D11';
SELECT * FROM AAM1365.A_MATRIX_CENT_201902 WHERE DIST = 'D12';
SELECT * FROM AAM1365.A_MATRIX_CENT_201902 WHERE DIST = 'D14';
SELECT * FROM AAM1365.A_MATRIX_CENT_201902 WHERE DIST = 'D30';
SELECT * FROM AAM1365.A_MATRIX_CENT_201902 WHERE DIST = 'D31';
SELECT * FROM AAM1365.A_MATRIX_CENT_201902 WHERE DIST = 'D32';
SELECT * FROM AAM1365.A_MATRIX_CENT_201902 WHERE DIST IN ( 'D50', 'D51', 'D53' );


/*SELECT * FROM AAM1365.A_MATRIX_CENT_201902 WHERE DIST = 'D50';
SELECT * FROM AAM1365.A_MATRIX_CENT_201902 WHERE DIST = 'D51';
SELECT * FROM AAM1365.A_MATRIX_CENT_201902 WHERE DIST = 'D53';*/
