...
*/
--DROP TABLE AAM1365.A_MATRIX_CENT_201711;

CREATE TABLE AAM1365.A_MATRIX_CENT_201711
	AS 
	(
	SELECT * FROM (
...
SELECT * FROM AAM1365.A_MATRIX_CENT_201711 WHERE DIST = 'D10';
SELECT * FROM AAM1365.A_MATRIX_CENT_201711 WHERE DIST = 'D11';
SELECT * FROM AAM1365.A_MATRIX_CENT_201711 WHERE DIST = 'D12';
SELECT * FROM AAM1365.A_MATRIX_CENT_201711 WHERE DIST = 'D14';
SELECT * FROM AAM1365.A_MATRIX_CENT_201711 WHERE DIST = 'D30';
SELECT * FROM AAM1365.A_MATRIX_CENT_201711 WHERE DIST = 'D31';
SELECT * FROM AAM1365.A_MATRIX_CENT_201711 WHERE DIST = 'D32';
SELECT * FROM AAM1365.A_MATRIX_CENT_201711 WHERE DIST IN ( 'D50', 'D51', 'D53' );


/*SELECT * FROM AAM1365.A_MATRIX_CENT_201711 WHERE DIST = 'D50';
SELECT * FROM AAM1365.A_MATRIX_CENT_201711 WHERE DIST = 'D51';
SELECT * FROM AAM1365.A_MATRIX_CENT_201711 WHERE DIST = 'D53';*/
