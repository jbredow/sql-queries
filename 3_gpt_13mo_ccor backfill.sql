-- move to price_mgmt schema
--TRUNCATE TABLE AAA6863.PR_PRICE_CAT_CCOR;
--DROP TABLE AAA6863.PR_PRICE_CAT_CCOR;
...
FROM (SELECT SUBSTR (ihf.YEARMONTH, 0, 4)
      ...
      WHERE     ILF.CUSTOMER_ACCOUNT_GK = cust.CUSTOMER_GK
            ...
            AND COALESCE (ilf.PRICE_CODE, 'N/A') IN ('R',
                                                     ...
                                                     'N/A',
                                                     'N')
            -- AND IHF.YEARMONTH BETWEEN '201706' AND '201806'
            --  AND ILF.YEARMONTH BETWEEN '201706' AND '201806'
...
GRANT SELECT ON AAA6863.PR_PRICE_CAT_CCOR TO PUBLIC;