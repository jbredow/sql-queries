...
SELECT DISTINCT *
  FROM (SELECT NEW_CUST.CUSTOMER_GK CUST_GK,
          ...
          FROM (SELECT DISTINCT
                       ...
                       CASE
                          WHEN LENGTH(TRIM(TRANSLATE(CUST.PRICE_COLUMN, ' +-.0123456789', ' '))) > 0
                          THEN
                             'N'
                  ...
                  FROM DW_FEI.CUSTOMER_DIMENSION CUST
                       ...
                       --AND CUST.CUSTOMER_TYPE NOT IN UST.PRICE_COLUMN NOT IN 'C'
                       ...
                       AND CUST.ACCOUNT_NUMBER_NK = '61'
                       --AND CUST.PRICE_COLUMN NOT IN '097'
