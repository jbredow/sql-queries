...
SELECT DISTINCT
       CASE
			 	WHEN sp_dtl.YEARMONTH BETWEEN '201502' AND '201601' THEN
					'CURR_12_MO'
				WHEN sp_dtl.YEARMONTH BETWEEN '201402' AND '201501' THEN
					'PREV_12_MO'
			END
				TPD,
       ...
       sp_dtl.PRICE_CODE,*/
			 CASE
    			...
    			WHEN sp_dtl.PRICE_CATEGORY in ( 'TOOLS', 'QUOTE', 'OTH/ERROR' ) THEN 'MANUAL'
