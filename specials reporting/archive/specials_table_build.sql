...
--use for table in schema to share out to group 

DROP TABLE AAA6863.PR_SPEC_CUST_12MO;

CREATE TABLE AAA6863.PR_SPEC_CUST_12MO
AS
SELECT DISTINCT
...
GRANT SELECT ON AAA6863.PR_SPEC_CUST_12MO TO PUBLIC;