...
DROP TABLE AAA6863.PR_VICT2_CUST_12MO_SPECIALS;

CREATE TABLE AAA6863.PR_VICT2_CUST_12MO_SPECIALS
AS
SELECT DISTINCT
		sp_dtl.YEARMONTH,
  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          ...
                          --      ('Q', 'N/A', 'R')
                          --AND IHF.WRITER = 'CMC'
                          AND CUST.ACCOUNT_NAME IN ('APPLE')
...
GRANT SELECT ON AAA6863.PR_VICT2_CUST_12MO_SPECIALS TO PUBLIC;