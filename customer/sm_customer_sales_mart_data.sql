...
SELECT
	CASE
		WHEN X.YEARMONTH BETWEEN '201408' AND '201509' THEN
			'PREV_12MO'
		ELSE
			'CURR_12MO'
	END
...
WHERE X.YEARMONTH BETWEEN  '201408' AND '201609'
	AND X.ACCOUNT_NUMBER_NK IN ( '1657', '226', '520', '1674', '3093' )
...
ALTER USER AAM1365 IDENTIFIED BY "[NEW_PASSWORD]" REPLACE "[OLD_PASSWORD]";
