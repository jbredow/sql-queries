...
SELECT
				 ...
				 IHF.YEARMONTH,
						...
						WHERE IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK --AND ILF.PRODUCT_STATUS = 'SP'
							  AND IHF.ACCOUNT_NUMBER IN (
													'226',	'448',	'520',	'1020',	'1550',	
													'564',	'1480',	'2000',	'61',	'88',	
													'1616',	'1895',	'2721',	'1083',	'1423',	
													'1657',	'1674',	'3093',	'13',	'20',	
													'116',	'190',	'230',	'454',	'480',	
													'1539',	'1600',	'1701',	'2637',	'3011',	
													'56',	'100',	'150',	'215',	'216',	
													'1869',	'788',	'1105',	'1116',	'1221',	
													'3083',	'8423',	'1476',	'1491',	'1934',	'2516'
																						)
								--AND IHF.ACCOUNT_NUMBER = '88'
							  --AND NVL (ILF.PRICE_CODE, 'N/A') IN
							  --      ('Q', 'N/A', 'R')
							  AND CUST.PRICE_COLUMN IN ('020', '021', '024' )
								--AND IHF.WRITER = 'CMC'
	...
	--WHERE V2.ACCOUNT_NUMBER IN ('1480')
