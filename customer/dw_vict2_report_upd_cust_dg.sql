...
SELECT DISTINCT
       CASE
			 	WHEN sp_dtl.YEARMONTH BETWEEN '201503' AND '201602' THEN
					'CUR_TPD'
				ELSE
					'PREV_TPD'
				END
      ...
      /* sp_Dtl.CHANNEL_TYPE,
       ...
       sp_dtl.PRODUCT_NAME,
       sp_dtl.STATUS,*/
       SUM ( sp_dtl.SHIPPED_QTY ) EX_SHIPPED,
       ...
       sp_dtl.PRICE_CATEGORY_OVR,*/
			 CASE
				...
				WHEN sp_dtl.PRICE_CATEGORY LIKE 'MATRIX%' THEN
					'MATRIX'
				WHEN sp_dtl.PRICE_CATEGORY IN ( 'QUOTE', 'TOOLS', 'OTH/ERROR' ) THEN
					'MANUAL'
  ...
  FROM   ( SELECT SP_HIST.*,
             ...
             FROM           ( SELECT IHF.ACCOUNT_NUMBER,
                               ...
                               WHERE IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
																			...
																			AND IHF.ACCOUNT_NUMBER IN ( '1550', '448', '1020' ) --= '13'
																		  ...
																		  AND MAIN_CUSTOMER_NK IN ( '12467', '6501', '5847', '125144', '33310', '353384', '22620' )  --= '123'
