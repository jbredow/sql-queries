...
SELECT DISTINCT
       CASE
			 	WHEN sp_dtl.YEARMONTH BETWEEN '201402' AND '201501'
				THEN
					'PREVIOUS'
				ELSE
					'CURRENT'
       ...
       sp_dtl.PRICE_CODE,*/
			 case
				...
				then 'OVERRIDE'
					...
					case
						when sp_dtl.PRICE_CATEGORY = 'MATRIX_BID'
						then 'MATRIX'
						when sp_dtl.PRICE_CATEGORY in ( 'OTH/ERROR', 'QUOTE', 'TOOLS' )
						then 'MANUAL'
  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          ...
                          AND IHF.ACCOUNT_NUMBER IN ( '61', '1869' )
                          ...
                          AND CUST.CUSTOMER_NK IN ( '14145', '24351', '230869' )
                          ...
                          AND IHF.PO_WAREHOUSE_NUMBER IS NULL
													AND ILF.YEARMONTH BETWEEN '201402' AND '201601'
													AND IHF.YEARMONTH BETWEEN '201402' AND '201601'
