...
SELECT DISTINCT
       CASE
			 			WHEN sp_dtl.YEARMONTH BETWEEN '201608' AND '201705' THEN
								'CURRENT_FYTD'
						WHEN sp_dtl.YEARMONTH BETWEEN '201508' AND '201605' THEN
								'PREVIOUS_FYTD'
						ELSE
								'OTHER'
			 END
  ...
  FROM (SELECT SP_HIST.*,
          ...
          FROM (SELECT IHF.ACCOUNT_NUMBER,
                 ...
                 WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK
                       ...
                       --AND IHF.YEARMONTH = TO_CHAR (TRUNC (SYSDATE, 'MM') - 1, 'YYYYMM'))
											 AND ILF.YEARMONTH NOT BETWEEN '201606' AND '201607'
											 AND IHF.YEARMONTH NOT BETWEEN '201606' AND '201607'
       ...
       sp_dtl
	WHERE sp_dtl.DISCOUNT_GROUP_NK  IN (	'4794',
																				'4795',
																				'4796',
																				'4797',
																				'4798',
