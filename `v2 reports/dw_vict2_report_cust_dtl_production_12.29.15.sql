...
SELECT DISTINCT
       ...
       sp_dtl.PRICE_CODE,
			 CASE
			 	WHEN PRICE_CATEGORY_OVR = 'OVERRIDE' THEN
					'OVERRIDE'
				WHEN PRICE_CATEGORY LIKE 'MATRIX%' THEN
					'MATRIX'
				WHEN PRICE_CATEGORY IN ( 'TOOLS', 'QUOTE', 'OTH/ERROR' ) THEN 
					'MANUAL'
				ELSE PRICE_CATEGORY
			 END
				PRICE_CAT,
  ...
  FROM   ( SELECT SP_HIST.*,
             ...
             FROM           ( SELECT IHF.ACCOUNT_NUMBER,
                               ...
                               WHERE IHF.INVOICE_NUMBER_GK =
                                     ...
                                     --AND IHF.ACCOUNT_NUMBER IN ( '61', '190' )
 ...
 WHERE ( SUBSTR ( SWD.REGION_NAME,
       ...
       AND sp_dtl.DISCOUNT_GROUP_NK IN
             ( '5686',
               '5687',
               '5688',
               '5689',
