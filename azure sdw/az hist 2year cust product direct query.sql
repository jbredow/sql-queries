= Sql.Database("feieimazsrv1.database.windows.net,1433", "feieimazsdw1", [Query="
SELECT HIST.YEARMONTH,
       ...
       END
          AS PRICE_CATEGORY,
       CASE
          WHEN HIST.PRODUCT_GK IS NOT NULL 
...
WHERE SWD.DIVISION_NAME IN ('CENTRAL REGION', 'EAST REGION','WEST REGION')
   AND HIST.WAREHOUSE_NUMBER IN ('1194', '1463', '1467', '1468', '1470', '1471', '1472', '1474', '1688', '1879', '2000', '2035', '2411', '420', '5827', '598', '931', '933', '934', '937', '938', '939', '941', '942', '945')
GROUP BY HIST.YEARMONTH,
HIST.WAREHOUSE_NUMBER,
IHF.WRITER,
CASE
   WHEN HIST.PRODUCT_GK IS NOT NULL
   THEN PROD.MANUFACTURER
   ELSE SP_PROD.PRIMARY_VNDR
END,
CASE
   WHEN HIST.PRODUCT_GK IS NOT NULL
   THEN PROD.PRODUCT_NK
   ELSE SP_PROD.SPECIAL_PRODUCT_NK
END,
CASE
   WHEN HIST.PRODUCT_GK IS NOT NULL
