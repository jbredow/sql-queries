...
SELECT DISTINCT
       ...
       sp_dtl.BASE_GROUP_FORM,
       sp_dtl.JOB_GROUP_FORM,
       sp_dtl.BASE_PROD_FORM,
       sp_dtl.JOB_PROD_FORM
  FROM (SELECT SP_HIST.*,
        GR_OVR_BASE.FORMULA BASE_GROUP_FORM,
        GR_OVR_JOB.FORMULA JOB_GROUP_FORM,
        PR_OVR_BASE.FORMULA BASE_PROD_FORM,
        PR_OVR_JOB.FORMULA JOB_PROD_FORM,
