TRUNCATE TABLE PRICE_MGMT.PR_VICT2_SALES_MSTR;
DROP TABLE PRICE_MGMT.PR_VICT2_SALES_MSTR;

CREATE TABLE PRICE_MGMT.PR_VICT2_SALES_MSTR
NOLOGGING
AS
   SELECT DISTINCT
          V.YEARMONTH,
   ...
   FROM (SELECT SP_HIST.*,
                ...
                CORE.SUBLINE_COST,
                CORE.CLAIM_AMOUNT
         FROM PRICE_MGMT.PR_VICT2_SALES SP_HIST
