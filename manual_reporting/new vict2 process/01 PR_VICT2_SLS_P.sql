TRUNCATE TABLE PRICE_MGMT.PR_VICT2_SALES;
DROP TABLE PRICE_MGMT.PR_VICT2_SALES;

CREATE TABLE PRICE_MGMT.PR_VICT2_SALES
NOLOGGING
AS
   ...
   WHERE     IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK
         ...
         AND ILCF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK
         ...
         AND (TRUNC (IHF.INVOICE_DATE) >=  (SYSDATE - 30));
