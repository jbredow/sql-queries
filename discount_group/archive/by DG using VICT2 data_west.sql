SELECT
	...
	sp_dtl.ACCOUNT_NAME BRANCH_NAME,
	CASE
		WHEN sp_dtl.YEARMONTH BETWEEN '201208' AND '201307'
		THEN 'FY13'
		ELSE 'FY14'
	END
		PERIOD,
...
FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          ...
                          AND IHF.ACCOUNT_NUMBER IN ( '25','52','60','140','159','196','1205','1225',
													'1245','1598','2783','3','23','26','27','107','253',
													'1717')
