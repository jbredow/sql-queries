...
CREATE TABLE AAA6863.PR_PRICE_CAT_HISTORY_CCOR_07
     ...
     FROM (SELECT --SUBSTR (ihf.YEARMONTH, 0, 4) YYYY,
            ...
            WHERE     ILF.CUSTOMER_ACCOUNT_GK = cust.CUSTOMER_GK
                  ...
                  AND COALESCE (ilf.PRICE_CODE, 'N/A') IN ('R',
                                                           ...
                                                           'N/A',
                                                           'N')
                  AND IHF.YEARMONTH = '201807' --BETWEEN '201801' AND '201805'
                  AND ILF.YEARMONTH = '201807' --BETWEEN '201801' AND '201805'
