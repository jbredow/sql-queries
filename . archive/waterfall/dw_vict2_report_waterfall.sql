SELECT
		sp_dtl.YEARMONTH,
    CASE
      WHEN sp_dtl.WAREHOUSE_NUMBER IN ( '185', '1481', '2727', '5860', '3812' )
      THEN 'LOUISVILLE'
      WHEN sp_dtl.WAREHOUSE_NUMBER IN ( '93', '213', '291', '479', '566', '917', '1484', 
                                        '5825', '3810' )
      THEN 'LEXINGTON'
      WHEN sp_dtl.WAREHOUSE_NUMBER IN ( '78', '493', '1482', '2050', '3809', '8073', '3814' )
      THEN 'EVANSVILLE'
      WHEN sp_dtl.WAREHOUSE_NUMBER IN ( '290', '750', '1483', '1546', '1583', '2579',
                                        '2580', '2581', '5823', '3813' )
      THEN 'INDIANAPOLIS'
      WHEN sp_dtl.WAREHOUSE_NUMBER IN ( '1589', '124', '541', '1979', '1980', '8124', 
                                        '3815', '5826' )
      THEN 'COLUMBUS'
      WHEN sp_dtl.WAREHOUSE_NUMBER IN ( '141', '148', '348', '473', '563', '580', '1038',
                                        '1554', '1977', '2052', '2073', '2503' )
      THEN 'CINCINNATI'
      WHEN sp_dtl.WAREHOUSE_NUMBER IN ( '3811', '5824', '8482', '1480', '1992', '1591',
                                        '2785', '2476', '2072', '8072' )
      THEN 'OHVAL_OTHER'
      ELSE sp_dtl.ACCOUNT_NAME
    END
      AS BRANCH_NAME,
  ...
  FROM    (SELECT SP_HIST.*,
             ...
             FROM (SELECT IHF.ACCOUNT_NUMBER,
                    ...
                    WHERE IHF.INVOICE_NUMBER_GK = ILF.INVOICE_NUMBER_GK 
                          ...
                          AND IHF.ACCOUNT_NUMBER IN ( '448','3083','1895','1869','8423','520','150','1550','116',
                                    '61','788','1116','1674','3093','2637','190','1105','1701','1934','56','215',
                                    '13','1491','480','1221','100','2000','20','1423','2516','1480','230','226',
                                    '3011','454','1539','1616','1083','2721','1020','564','88','1657','1600','216',
                                    '1476')
