SELECT MAIN.ACCOUNT_NUMBER BR_NK,
       ...
       MAIN.WRITER,
			 CASE
					WHEN MAIN.CHANNEL_TYPE IN ( 'H1', 'O1' ) THEN
						'TRUCK'
					WHEN MAIN.CHANNEL_TYPE IN ( 'H2', 'H4', 'O2', 'O4' ) THEN
						'COUNTER'
					WHEN MAIN.CHANNEL_TYPE IN ( 'H3', 'O3' ) THEN
						'DIRECT'
					WHEN MAIN.CHANNEL_TYPE IN ( 'H5', 'O5' ) THEN
						'CREDIT'
					WHEN MAIN.CHANNEL_TYPE IN ( 'H6', 'O6', 'H7', 'O7' ) THEN
						'SHOWROOM'
					WHEN MAIN.CHANNEL_TYPE IN ( 'H8', 'O8' ) THEN
						'E_BUSINESS'
			 END
				CHANNEL,
       --MAIN.SHIP_VIA,
