/* Misc / Other DG's  */
--DROP TABLE AAA6863.A_DPRO_MIDWEST;

CREATE TABLE AAA6863.A_DPRO_MIDWEST AS
...
FROM
  ...
  WHERE wpf.warehouse_gk = whse.warehouse_gk
	--AND wpf.discount_group_nk = LPAD(other.dg_nk, 4, '0')
...
GRANT SELECT ON AAA6863.A_DPRO_MIDWEST TO PUBLIC;