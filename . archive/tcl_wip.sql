--CREATE TABLE AAM1365.DPRO_TEST AS

SELECT
	WPF.PRODUCT_NK Prod,
	WPF.PRODUCT_NK || '*' || WPF.WAREHOUSE_NK COMBO_CODE,
...
WHERE WPF.WAREHOUSE_GK = WHSE.WAREHOUSE_GK
  ...
  AND WHSE.WAREHOUSE_GK = PO.WAREHOUSE_NUMBER_GK
  AND PO.PRODUCT_GK = WPF.PRODUCT_GK
	AND PROD.DISCOUNT_GROUP_NK = '2122'
	--AND PROD.OBSOLETE_FLAG = 0 
	--AND PROD.LIST_PRICE <> 0
	--AND PROD.LIST_PRICE = 0
	AND WHSE.ACCOUNT_NAME = 'DETROIT'
