--CREATE TABLE AAA6863.A_MATRIX_MIDWEST_1013 AS
...
SELECT * FROM (
	...
	WHERE PRICE.BRANCH_NUMBER_NK = CONTACTS.ACCOUNT_NK
		...
		AND dg.discount_group_nk = '5056'
		AND (PRICE.PRICE_COLUMN   NOT  	 IN (170, 171, 172, 173,
											180, 181, 182, 183,
											190, 191, 192, 193)
		AND PRICE.PRICE_TYPE         = 'G'
		AND CONTACTS.RPC             = 'Midwest'
		AND PRICE.DELETE_DATE       IS NULL
		AND CONTACTS.ACCOUNT_NK     IN ('1116','13')
		)
UNION
	SELECT DISTINCT 
		--products
...
--GRANT SELECT ON aaa6863.a_matrix_midwest_1013 TO PUBLIC;